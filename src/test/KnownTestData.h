...
const& getKnownTx()
{
    ...
    /*
    Deserialized: "F2D008D2AABBABD2A882F9049AA873210908EC3EA1EB0A2044A66093C7ACD2B1" = {Transaction = {TransactionType = Payment, Flags = 2147483648, Account = rG1QQv2nh2gr7RCZ1P8YYcBUKCCN633jCn, Sequence = 18, 100/XRP, SigningPubKey = 0388935426E0D08083314842EDFBB2D517BD47699F9A4527318A8E10468C97C052, TxnSignature = 3044022030425DB6A46B5B57BDA85E5B8455B90DC4EC57BA1A707AF0C28DC9383E09643D0220195B9FDBE383B813A539F3B70E130482E92D1E1210B0F85551E11B3F81EB98BB, Destination = rHb9CJAWyB4rj91VRWn96DkukG4bwdtyTh, 123400000/USD/rhub8VRN55s94qWKDv6jmDy1pUykJzF3wq, 5678900000000000e-4/CNY/razqQKzJRdB4UxFPWf5NEpEG3WMkmwgcXA}}
    */
    return testTx;
}
...
#if 0
// Ledger serialization unsupported because it's not
// supported in ripple-libpp
inline
TestItem
const& getKnownLedger()
{
    // From ledger 28781798 (chosen arbitrarily)
    static TestItem testLedger{
        R"({
            "accepted" : true,
            "account_hash" : "AF5F8FEAC79C845B2510D7B73E048E34DD2D40D662B3CA6039481767D18603B0",
            "close_flags" : 0,
            "close_time" : 544608901,
            "close_time_human" : "2017-Apr-04 08:15:01",
            "close_time_resolution" : 10,
            "closed" : true,
            "hash" : "506A2B2097BA5ACB99312F3226116473BBB64490B8832C571237661B702AA04D",
            "ledger_hash" : "506A2B2097BA5ACB99312F3226116473BBB64490B8832C571237661B702AA04D",
            "ledger_index" : "28781798",
            "parent_close_time" : 544608900,
            "parent_hash" : "7821D210E0848C13A51481A29942D98CE3D18ECFA2D36439A827FF7911B62632",
            "seqNum" : "28781798",
            "totalCoins" : "99995164195529746",
            "total_coins" : "99995164195529746",
            "transaction_hash" : "3687969BE2FF579E64802222958259FDB4166B14252BB9BC89F3A4DF26BAF230"
        })",
        "01B72CE6016341127121A4127821D210E0848C13A51481A29942D98CE3D18ECFA"
        "2D36439A827FF7911B626323687969BE2FF579E64802222958259FDB4166B1425"
        "2BB9BC89F3A4DF26BAF230AF5F8FEAC79C845B2510D7B73E048E34DD2D40D662B"
        "3CA6039481767D18603B020761284207612850A00"
    };
    return testLedger;
}
#endif
